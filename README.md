...
(5) Open in the browser: `http://localhost/keplers-laws/keplers-laws_en.html` (You will probably need to modify this
...
(3) Open in the
browser: `http://localhost/keplers-laws/build/adapted-from-phet/keplers-laws_en_adapted-from-phet.html` (You will
